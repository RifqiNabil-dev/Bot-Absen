    ...
    if (interaction.isChatInputCommand()) {
      ...
      if (customId === "take_attendance") {
        ...
        try {
          ...
          // Get server profile name (nickname or username)
          const profileName =
        ...
        try {
          ...
          if (embed) {
            ...
            const listString = updatedAttendance
              .map((record, index) => `${index + 1}. ${record.profile_name}`)
              .join("\n");
